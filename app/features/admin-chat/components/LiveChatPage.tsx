  ...
  return (
    <div className="h-14 border-b border-gray-200 bg-white flex items-center gap-3 px-4 flex-shrink-0">
      ...
      <Link
        href="/dashboard"
        onClick={onClose}
        className="text-[11px] font-semibold text-blue-600 border border-blue-200 bg-blue-50 hover:bg-blue-100 rounded-lg px-3 py-1.5 transition-colors flex-shrink-0"
      >
        Back Home
      </Link>
    </div>
